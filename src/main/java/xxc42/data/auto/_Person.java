...
public abstract class _Person extends BaseDataObject {
    ...
    public static final ListProperty<Company> COMPANIES = PropertyFactory.createList("companies", Company.class);

    protected String name;

    protected Object companies;
